...
from src.utils.resample import resampling_kernel
...
def test_resampling_kernel(log_weights, expected_ess, expected_normalized_weights):
...
def test_resampling_kernel_sum_weights_near_zero():
  ...
  assert jnp.allclose(normalized_weights, jnp.array([0.25, 0.25, 0.25, 0.25]), atol=1e-6)
