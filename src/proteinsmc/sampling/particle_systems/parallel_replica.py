...
if TYPE_CHECKING:
  ...
  def _run_prsmc_chunk(  # noqa: PLR0913
    ...
    def _prsmc_step(carry_state: SamplerState, _: Int) -> tuple[SamplerState, SamplerOutput]:
      ...
      log_z_estimates = (
        carry_state.additional_fields["logZ_estimate"] + infos.log_likelihood_increment
      )
      ...
      meta_beta = annealing_fn(carry_state.step, None)
    ...
    final_state, collected_outputs = lax.scan(_prsmc_step, initial_state, jnp.arange(chunk_size))
